...
//        let attrString = NSMutableAttributedString(string: string, attributes: attrs)
        ...
        let strokeTextAtrributes: [NSAttributedStringKey : Any] = [
            NSAttributedStringKey.strokeColor : UIColor.init(red: 0, green: 0, blue: 0, alpha: 0.8),
            NSAttributedStringKey.strokeWidth : -1 * 1,
            ]
        
        
        let attrString = NSMutableAttributedString(string: string, attributes: strokeTextAtrributes);
        
        
//        NSMutableAttributedString.init(string: <#T##String#>, attributes: <#T##[NSAttributedStringKey : Any]?#>)
...
//        NSMutableAttributedString.init(string: <#T##String#>, attributes: <#T##[NSAttributedStringKey : Any]?#>)
    ...
    class func GetReadFrameRef(content:String, attrs:[String : Any]?, rect:CGRect) ->CTFrame {
        ...
        let attributedString = NSMutableAttributedString(string: content,attributes: strokeTextAtrributes)
